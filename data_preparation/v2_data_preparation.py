...
# Declaration of input and output is defined in __name__ == "__main__"
...
if __name__ == "__main__":
    ...
    datasets_info = {
        'full_dataset.json': {"dc.title", "dc.contributor.tiedekunta", "dc.description.abstract", "dc.subject.other", "dc.subject.yso", "dc.language.iso", "dc.date.issued"},
        'tags_dataset.json': {"dc.title", "dc.contributor.tiedekunta", "dc.subject.other", "dc.subject.yso","dc.date.issued"}
    }
    field_name_mapping = {
