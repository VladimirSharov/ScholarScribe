...
def stratify_and_split(input_path, train_ratio=0.8, val_ratio=0.1, test_ratio=0.1):
    ...
    output_train_path = f'prepared_datasets/{base_name}_train.json'
    output_val_path = f'prepared_datasets/{base_name}_val.json'
    output_test_path = f'prepared_datasets/{base_name}_test.json'
